            ...
            <div className="mx-auto relative borde space-y-5 pb-7 max-w-6xl grid grid-cols-2  gap-4">
                {selectedText === selectedText && (
                    <div className="max-w-99 borde">
                        ...
                        />
                        <a
                            className=" mx-auto flex justify-center max-w-65  relative top-10"
                            href="https://www.ejemplo.com"
                        >
                            <Buttons text={` ${selectedText}.com`} />
                        </a>
                    </div>
                )}
                ...
                <div className="borde grid justify-center">
                    {buttonTexts.map((buttonText, index) => (
                        <Buttons
                            ...
                            onClick={() => handleClick(buttonText.text)}
                        />
                    ))}
                </div>
            </div>
